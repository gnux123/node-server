var events = {
	control: function(eventContent){
		...
		var test2 = test.splice(bodyChartNums+7,0, "<script src='/img/Activity/js/itemsPostData.js' charset='utf-8'></script><script type='text/javascript'>$(function(){ itemSingle.collectData(); });</script>");
		return test2;
	}
}
